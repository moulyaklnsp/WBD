export const organizerLinks = [
  ...
  { path: '/organizer/coordinator_performance', label: 'Coordinator Performance', icon: 'fas fa-chart-line' },
  { path: '/organizer/growth_analysis', label: 'Growth Analysis', icon: 'fas fa-chart-area' },
