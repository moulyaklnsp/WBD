...
const ChessTransformation = ({ autoPlay = true, speed = 2, scale = 1, minimal = false }) => {
          ...
          gsap.to(pieceRef.current, {
            ...
            onComplete: () => {
              ...
              gsap.fromTo(pieceRef.current, 
                ...
                { rotation: 0, opacity: 1, duration: 0.6, ease: "back.out(1.7)" }
              );
            }
          });
...
export const GlobalLoader = ({ style }) => (
  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', padding: '2rem', ...style }}>
    <ChessTransformation autoPlay={true} speed={1.5} scale={0.6} minimal={true} />
  </div>
);
