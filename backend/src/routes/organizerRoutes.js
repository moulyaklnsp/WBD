...
/**
 * @swagger
 * /organizer/api/coordinators/pending:
 *   get:
 *     summary: List pending coordinator signups
 *     tags: [Organizer]
 *     security:
 *       - bearerAuth: []
 */
router.get('/api/coordinators/pending', organizerController.getPendingCoordinators);

/**
 * @swagger
 * /organizer/api/coordinators/approve:
 *   post:
 *     summary: Approve or reject a pending coordinator signup
 *     tags: [Organizer]
 *     security:
 *       - bearerAuth: []
 */
router.post('/api/coordinators/approve', organizerController.approveCoordinator);
