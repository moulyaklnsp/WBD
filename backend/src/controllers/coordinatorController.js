...
const getPublishedBlogsPublic = async (req, res) => {
  try {
    const data = await BlogsService.getPublishedBlogsPublic(null);
    return res.status(200).json(data);
  } catch (error) {
...
const getBlogByIdPublic = async (req, res) => {
  try {
    ...
    const data = await BlogsService.getBlogByIdPublic(null, user, { id: req.params.id });
    return res.status(200).json(data);
  } catch (error) {
...
const getBlogReviews = async (req, res) => {
  try {
    const data = await BlogsService.getBlogReviews(null, { id: req.params.id });
    return res.status(200).json(data);
  } catch (error) {
